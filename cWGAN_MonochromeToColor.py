# -*- coding: utf-8 -*-
"""MonochromeToColor.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1sL2LBi2i8FRVQqrPJ1W3F0k6w9LyAcsB
"""
...
def save_progress(cond, real, fake, current_epoch = 0, output_dir="output_images", figsize=(20,15)):
    """
...
class CWGAN(pl.LightningModule):
    ...
    def __init__(self, in_channels, out_channels, learning_rate=0.0002, lambda_recon=100, display_step=5, lambda_gp=10, lambda_r1=10,):
...
# ****************** self.current_epoch가 업데이트 되지 않고 있음***************************
